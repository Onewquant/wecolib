...
setup(
    ...
    install_requires = ['PyAutoGUI<=0.9.39','PyQt5','SQLAlchemy','XlsxWriter','beautifulsoup4','bs4','certifi','idna','lxml','matplotlib','numpy','openpyxl','pandas<=0.22.0','pyodbc','pywin32','pywinauto','requests','scipy','seaborn','selenium','urllib3','xlrd','pywin32' ],
